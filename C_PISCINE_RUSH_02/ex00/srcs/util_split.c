...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/01 19:57:23 by donghyle          #+#    #+#             */
/*   Updated: 2022/05/01 19:57:27 by donghyle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	count_words_by_sep(char *str, int *is_sep)
{
	int	n_words;
...
char	**ft_split(char *str, char *charset)
{
	...
	n_words = count_words_by_sep(str, is_sep);
	idx = 0;
